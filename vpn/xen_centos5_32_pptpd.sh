...
function installVPN(){
	...
	wget http://www.hi-vps.com/downloads/pptpd-1.3.4-1.rhel5.1.i386.rpm
	wget http://www.hi-vps.com/downloads/ppp-2.4.4-9.0.rhel5.i386.rpm
